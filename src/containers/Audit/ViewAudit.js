      ...
      data: [
        {
          ...
          "full_report_link": "https://s3.amazonaws.com/majestic-dev/MountainViewAgedCarePlusCentre_September20" +
              "17_audit_report.pdf",
          "graph_report_link": "https://s3.amazonaws.com/majestic-dev/MountainViewAgedCarePlusCentre_September20" +
              "17_summary_graph.pdf",
          "rectification_report_link": "https://s3.amazonaws.com/majestic-dev/MountainViewAgedCarePlusCentre_September20" +
              "17_audit_rectification_report.pdf"
        }, {
          "id": 5,
          "state_id": 6,
          "facility_id": 9,
    ...
    const auditList = this
      ...
      .map((item, i) => {
        return <tr key={i}>
          ...
          <td className="text-center">
            <AHref linkUrl={item.graph_report_link}></AHref>
          </td>
          <td className="text-center">
            <AHref linkUrl={item.rectification_report_link}></AHref>
          </td>
        </tr>
      });
              ...
              <table id="datatable" className="table colvis-data-table table-striped tbl-top">
                ...
                <thead>
                  <tr>
                    ...
                    <th className="text-center">Audit Start Date
                    </th>
                    <th className="text-center">Audit End Date
                    </th>
